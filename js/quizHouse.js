...
var score=0;
    ...
    $.getJSON('/Json/house.json', function(data) {

    for(i=0;i<data.quizlistHouse.length;i++){ 
      questionBank[i]=new Array;

      questionBank[i][0]=data.quizlistHouse[i].option1;//first option is always right answer!
      questionBank[i][1]=data.quizlistHouse[i].option2;
      questionBank[i][2]=data.quizlistHouse[i].option3;
      questionBank[i][3]=data.quizlistHouse[i].option4;
      questionBank[i][4]=data.quizlistHouse[i].question;//question
      questionBank[i][5]=data.quizlistHouse[i].option1;// Take Rigrht answer to check if user choose right or wrong
    }
